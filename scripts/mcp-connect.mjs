...
say('Le jeton expire dans 7 jours : relance simplement ce script.\n');

function r2plan(t) { try { return JSON.parse(Buffer.from(t.split('.')[1].replace(/-/g, '+').replace(/_/g, '/'), 'base64').toString()).plan || '?'; } catch (_) { return '?'; } }
