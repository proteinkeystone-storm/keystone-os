...
${editorBlock}
      ...
      <p>Keystone OS est accessible par abonnement, avec un essai gratuit de 7 jours, sans carte bancaire. Le périmètre fonctionnel évolue régulièrement ; nous documentons les engagements de confiance sur les pages dédiées : <a href="/securite">Sécurité</a>, <a href="/confidentialite">Confidentialité</a>, <a href="/dpa">Sous-traitants (DPA)</a> et <a href="/reversibilite">Réversibilité des données</a>.</p>`,
...
PAGES.push(trustPage({
  ...
  body: `      <h3>1. Objet</h3>
      ...
      <p>L’accès se fait via une licence activée par e-mail, avec un essai gratuit de 7 jours, sans carte bancaire ; au-delà, un abonnement actif est requis. Vous êtes responsable de la confidentialité de votre accès.</p>
...
PAGES.push(trustPage({
  ...
  desc: 'Conditions générales de vente de Keystone OS : abonnements, paiement via Stripe, gestion via le portail client, droit de rétractation et résiliation. Essai gratuit de 7 jours, sans carte bancaire.',
  h1a: 'Conditions générales', h1b: 'de vente.',
  lead: 'Les conditions applicables aux abonnements. Chaque offre débute par un essai gratuit de 7 jours, sans carte bancaire ; au-delà, l’accès nécessite un abonnement actif.',
  body: `      <h3>1. Offres & abonnements</h3>
      <p>Keystone OS est proposé sous forme d’abonnements donnant accès à un ensemble d’outils. Les prix et le détail des offres sont indiqués sur la page <a href="/#plans">Tarifs</a>. Chaque abonnement débute par un essai gratuit de 7 jours, sans carte bancaire.</p>
      <h3>2. Paiement</h3>
      ...
      <p>Droit français. Tout litige relève des tribunaux français à défaut de solution amiable.</p>
      <div class="note"><b>Essai gratuit.</b> Chaque abonnement débute par 7 jours d’essai, sans carte bancaire. Vous pouvez résilier à tout moment depuis le portail client Stripe.</div>`,
...
## Statut
Service actif par abonnement, avec un essai gratuit de 7 jours, sans carte bancaire. Le périmètre évolue régulièrement.
