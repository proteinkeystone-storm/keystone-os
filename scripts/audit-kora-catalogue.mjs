...
const CAP = { brainstorming:'séances', ghostwriter:'posts', social:'réseaux', sdqr:'QR', sentinel:'sites', keynapse:'Keynapse', smartagent:'jumeaux', desk:'desK', book:'booK', keybrand:'Key Brand', keyform:'Key Form', network:'networK' };
