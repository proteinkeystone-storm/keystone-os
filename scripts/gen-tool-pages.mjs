...
function FOOT() {
  return `  <footer class="foot">
    <div class="foot-cols">
      ...
      <div class="foot-col"><h4>Siège</h4>
        <address>1489 Route des Gorges<br>83190 Ollioules<br>France</address>
      </div>
    </div>
    <div class="foot-copy">© 2026 Protein Keystone OS — Tous vos outils métier, un seul OS.</div>
  </footer>`;
}
