...
7. 🔴 **Trou connu, différé volontairement** : un pack remboursé via Stripe **n'est pas repris** (le webhook n'écoute pas `charge.refunded`). Constaté en réel le 25/07. Décision Stéphane : acceptable en beta, tâche mise de côté pour l'ouverture commerciale de septembre.
