...
1. **Plafonner les conversations** — 🟡 **ARMÉ SUR LA LICENCE TÉMOIN (2026-07-25), pas sur les autres.**
   ...
   - **Reste** : observer le mur en réel, puis décider de l'ouverture aux autres licences. **Les messages « Crédits IA épuisés » de Smart Agent, Brainstorming, Sentinel, Keynapse, Kora et QR n'ont PAS été repassés en « conversations »** (hors chemin du témoin) — à faire avant d'armer une licence qui possède ces apps.
