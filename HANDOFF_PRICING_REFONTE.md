...
- Hygiène Stripe restante (Stéphane) : supprimer l'endpoint webhook du **mode test** ; vérifier que le mode **production** garde son endpoint actif vers `…workers.dev/api/stripe/webhook`.
