...
export const CATALOG_DATA = {
    ...
    tools: [
        ...
        { id:'A-COM-003', padKey:null, title:'Muse', subtitle:'Le moodboard de référence pour votre studio 3D · Prompt Maître + 4 CTA images', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'palette', ai_optimized:'Claude', isNew:true, published:true, tags:['artefact','moodboard','studio-3d','illustration-immobiliere','midjourney','flux','muse'],
          longDesc:"Muse prépare le moodboard de références à transmettre à votre studio 3D spécialisé en illustration immobilière. Configurez cadrage (drone, piéton, intérieur, terrasse) et atmosphère (lumière, saison, palette végétale, figuration, matériaux). Muse assemble un Prompt Maître structuré à coller dans votre IA (Claude, Gemini, ChatGPT) ; en retour, un fichier HTML avec 4 boutons \"Copier\" pour générer des images de référence (Midjourney, Flux, DALL-E, Nano Banana) — Architecture, Lifestyle, Palette végétale, Textures. Ces images ne sont pas votre projet (le studio le modélise sur plan), mais des inspirations d'ambiance \"dans le même esprit\"." },
    ],
};
