...
export const CATALOG_DATA = {
    ...
    tools: [
        ...
        { id:'O-IMM-002', padKey:'A2', title:'Annonces Multi-Portails', subtitle:'SeLoger · LeBonCoin · Bien\'ici · Logic-Immo · Figaro Immo', category:'IMM', plan:'STARTER', price:29, lifetimePrice:149, icon:'multiportails', ai_optimized:'ChatGPT', isNew:true, published:true, tags:['immobilier','annonce','seloger','leboncoin','bienici','diffusion','portails','copywriting'],
        ...
        { id:'A-COM-001', padKey:null, title:'Sovereign Dynamic QR', subtitle:'QR codes dynamiques · stats souveraines · RGPD', category:'COM', plan:'PRO', price:49, lifetimePrice:199, icon:'sdqr', ai_optimized:'Claude', isNew:true, published:true, tags:['artefact','qr','marketing','tracking','vcard','wifi','sovereign','rgpd'],
        ...
        { id:'A-COM-002', padKey:null, title:'Kodex', subtitle:'Le brief print/digital infaillible · calculateur d\'échelle', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'kodex', ai_optimized:'Claude', isNew:true, published:true, tags:['artefact','print','digital','brief','communication','production'],
        ...
        { id:'A-COM-003', padKey:null, title:'Muse', subtitle:'La planche d\'ambiance pour votre studio 3D · 1 prompt → 1 moodboard complet', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'muse', ai_optimized:'Claude', isNew:true, published:true, tags:['artefact','moodboard','planche-ambiance','studio-3d','illustration-immobiliere','midjourney','flux','muse'],
        ...
        { id:'A-COM-004', padKey:null, title:'Pulsa', subtitle:'Le formulaire intelligent · URL partageable · notif direction', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'pulsa', ai_optimized:'Claude', isNew:true, published:true, tags:['artefact','formulaire','questionnaire','diagnostic','onboarding','collecte','communication','pulsa'],
