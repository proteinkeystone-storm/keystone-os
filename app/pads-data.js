...
export const CATALOG_DATA = {
    ...
    tools: [
        ...
        { id:'O-SOC-001', padKey:null, title:'Social Manager', subtitle:'Composez et publiez sur vos réseaux — Facebook, Instagram, LinkedIn', category:'COM', plan:'PRO', price:49, lifetimePrice:199, icon:'multiportails', ai_optimized:'Claude', isNew:true, published:true, timeSaved:20, tags:['artefact','social','reseaux','facebook','instagram','linkedin','diffusion','publication','community'],
