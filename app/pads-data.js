...
export const CATALOG_DATA = {
    ...
    tools: [
        ...
        { id:'A-COM-003', padKey:null, title:'Muse', subtitle:'La planche d\'ambiance pour votre studio 3D · 1 prompt → 1 moodboard complet', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'palette', ai_optimized:'Claude', isNew:true, published:true, tags:['artefact','moodboard','planche-ambiance','studio-3d','illustration-immobiliere','midjourney','flux','muse'],
        ...
        { id:'A-COM-004', padKey:null, title:'Pulsa', subtitle:'Le formulaire intelligent · URL partageable · notif direction', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'check-square', ai_optimized:'Claude', isNew:true, published:true, tags:['artefact','formulaire','questionnaire','diagnostic','onboarding','collecte','communication','pulsa'],
