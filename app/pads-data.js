...
export const CATALOG_DATA = {
    ...
    tools: [
        ...
        { id:'A-COM-001', padKey:null, title:'Dynamic QR', subtitle:'QR codes dynamiques · stats souveraines · RGPD', category:'COM', plan:'PRO', price:49, lifetimePrice:199, icon:'sdqr', ai_optimized:'Claude', isNew:true, published:true, timeSaved:10, tags:['artefact','qr','marketing','tracking','vcard','wifi','sovereign','rgpd'],
