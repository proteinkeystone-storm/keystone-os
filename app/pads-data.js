...
export const CATALOG_DATA = {
    ...
    tools: [
        ...
        { id:'A-COM-003', padKey:null, title:'Brainstorming', subtitle:'9 personnalités IA dialoguent pour enrichir votre réflexion', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'muse', ai_optimized:'Claude + Gemma 4', isNew:true, published:true, timeSaved:30, tags:['artefact','brainstorming','ideation','creatif','multi-agent','synthese','reflexion','strategie'],
          longDesc:"Brainstorming est un atelier de réflexion collective où 9 personnalités IA spécialisées dialoguent en direct pour enrichir votre pensée stratégique. Vous posez un sujet, choisissez un mode de réflexion (Exploration, Lancement, Branding…) et les 9 personnalités s'allument : Strategic Lead coordonne, Creative Director propose des angles audacieux, Growth Hacker traduit en leviers, Consumer Psychologist révèle les motivations, Brand Guardian veille à la cohérence, Cultural Analyst capte les signaux émergents, Data Analyst confronte aux ordres de grandeur, Devil's Advocate remet en question, Synthesizer conclut. Vous orientez la conversation à la volée. Synthèse + plan d'actions exportable PDF." },
        ...
        { id:'O-SOC-001', padKey:null, title:'Social Manager', subtitle:'Composez et publiez sur vos réseaux — Facebook, Instagram, LinkedIn', category:'COM', plan:'PRO', price:49, lifetimePrice:199, icon:'user', ai_optimized:'Claude', isNew:true, published:true, timeSaved:20, tags:['artefact','social','reseaux','facebook','instagram','linkedin','diffusion','publication','community'],
          longDesc:"Social Manager pilote la diffusion de vos contenus sur les réseaux sociaux depuis un seul endroit. Composez une publication (texte + photo), choisissez les réseaux connectés (Facebook, puis Instagram et LinkedIn), publiez en un clic. Les comptes sont reliés de façon sécurisée côté serveur (tokens chiffrés), les images hébergées automatiquement. Aperçu en direct avant envoi. Socle extensible : chaque nouveau réseau s'ajoute sans refonte." },
        ...
        { id:'O-AGT-001', padKey:null, title:'Smart Agent', subtitle:'Jumeau numérique de votre savoir-faire — répond par chat, voix ou QR, sans rien inventer', category:'COM', plan:'MAX', price:49, lifetimePrice:199, icon:'smart-agent', ai_optimized:'Mistral', isNew:true, published:true, timeSaved:60, tags:['artefact','agent','savoir','kortex','expertise','jumeau','assistant','connaissance','vendeur','voix','qr'],
          longDesc:"Smart Agent transforme votre savoir-faire en un assistant que vos clients interrogent par chat, à la voix ou via un simple QR code — sans compte. Nourrissez son coffre de savoir en quelques minutes : partez d'un pack métier prêt à l'emploi (vendeur, agent immobilier, gardien de musée, concierge, guide, SAV), collez un texte, importez une page de votre site ou un PDF, ou répondez à l'oral à l'interview guidée — l'IA structure tout en fiches que vous validez. Donnez-lui sa personnalité : rôle, ton, style et objectif (informer, conseiller ou vendre). En service, il répond UNIQUEMENT depuis votre savoir validé — jamais d'invention : s'il ne sait pas, il le dit, et la question remonte dans sa liste de travail pour que vous la combliez. Un vendeur, un concierge, un formateur : même moteur, votre savoir. Voix neuronale française incluse." },
        ...
        { id:'O-Keyn-001', padKey:null, title:'Keynapse', subtitle:'Vos idées en bulles vivantes — une constellation de notes qui respire', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'keynapse', ai_optimized:'Whisper', isNew:true, published:true, timeSaved:30, tags:['artefact','notes','idées','constellation','mindmap','bulles','vocal','rappels','carte mentale','keynapse'],
          longDesc:"Keynapse transforme vos idées en une constellation vivante. Chaque note est une bulle — projet, idée, personne, lieu, tâche — que vous posez sur un canevas infini et reliez aux autres pour tisser votre carte mentale. Les bulles respirent et se regroupent en zones colorées, sans dossiers : votre pensée s'organise par la couleur, la proximité et les liens. Chaque bulle contient description, tâches, rappels, photos, croquis et notes vocales — et chaque section vide disparaît pour une fiche toujours nette. Dictez un mémo : il est transcrit, et Keynapse vous propose tâches et rappels à valider." },
        ...
        { id:'O-GEO-001', padKey:null, title:'Sentinel', subtitle:'Auditez et surveillez vos sites web — disponibilité, SEO, visibilité IA', category:'WEB', plan:'STARTER', price:49, lifetimePrice:199, icon:'sentinel', ai_optimized:'Mistral', isNew:true, published:true, timeSaved:40, tags:['artefact','web','audit','seo','geo','monitoring','surveillance','performance','wix','wordpress'],
          longDesc:"Sentinel est un centre de contrôle qui surveille vos sites web en continu — disponibilité, performance, SEO technique, sécurité — et vous alerte au moindre incident. Il note chaque site, suit l'évolution dans le temps, et livre des correctifs clé en main : le code prêt à coller ou des instructions pas-à-pas selon votre plateforme (Wix, WordPress, sur-mesure), délégables à votre webmaster en un clic. Killer feature : la visibilité dans les IA génératives (GEO) — savez-vous si ChatGPT, Perplexity ou Gemini parlent de vous ? Souverain, sans dépendance à des outils tiers." },
        ...
        { id:'O-NET-001', padKey:null, title:'networK', subtitle:'Votre réseau relationnel vivant — vos contacts en carte mentale, pas en base de données', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'network', ai_optimized:null, isNew:true, published:true, timeSaved:20, tags:['artefact','contacts','reseau','relations','crm','carte mentale','clients','fournisseurs','partenaires','network'],
          longDesc:"networK n'est pas un carnet d'adresses de plus : c'est votre réseau relationnel vivant. Vous êtes au centre, et vos relations se déploient en carte mentale — clients, fournisseurs, partenaires, équipe, presse — dans des catégories que vous créez librement. Chaque contact ouvre une fiche claire : coordonnées, rôles, tags, notes et un journal d'activité qui raconte votre relation comme une histoire. Et depuis chaque fiche, continuez votre travail sans ressaisir : envoyez une Missive, générez un Brief, ouvrez votre Smart Agent — tout part déjà pré-rempli. Zéro IA, zéro crédit : votre réseau vous appartient." },
        ...
        { id:'O-BOK-001', padKey:null, title:'booK', subtitle:'Vos flipbooks en un fichier qui s\'ouvre partout, pour toujours — sans abonnement, sans serveur', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'book', ai_optimized:null, isNew:true, published:true, timeSaved:15, tags:['artefact','communication','flipbook','catalogue','magazine','brochure','plaquette','menu','pdf','book','publication','editorial'],
          longDesc:"booK transforme votre PDF ou vos images en flipbook élégant — catalogue, magazine, plaquette, book, menu — que l'on feuillette comme un vrai livre, page tournée comprise. La différence avec tout ce qui existe : votre publication est UN SEUL fichier autonome, qui s'ouvre d'un double-clic, partout, pour toujours — sans serveur, sans abonnement, sans watermark, sans dépendre de Keystone. Envoyez-le par e-mail, posez-le sur une clé USB, archivez-le : il vous appartient, et il reste même rééditable en le ré-important dans booK. Zéro IA, zéro crédit : tout est inclus." },
        ...
        { id:'O-DSK-001', padKey:null, title:'desK', subtitle:'Le chemin de fer vivant de votre revue — qui doit livrer quoi, quand, et quoi faire quand ça dérape', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'desk', ai_optimized:null, isNew:true, published:true, timeSaved:25, tags:['artefact','communication','revue','magazine','journal','redaction','chemin de fer','bouclage','editorial','presse','flatplan'],
          longDesc:"desK pilote la production de votre revue : le chemin de fer devient une frise vivante de cartes-pages, partagée par l'équipe. Chaque article affiche sa marge réelle avant le bouclage — et tant qu'elle tient, rien ne s'allume. Quand un retard la consomme, la carte passe à l'ambre puis au rouge, et l'inspecteur vous tend la décision : relancer le contributeur, ou basculer sur un remplaçant préparé au banc. Simulez un report de remise et voyez la date d'impression réagir en direct. La maquette reste dans InDesign : desK est le cockpit autour. Multi-revues, équipe invitée par e-mail, zéro IA au cœur." },
    ],
};
