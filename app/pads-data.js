...
export const CATALOG_DATA = {
    ...
    tools: [
        ...
        { id:'O-Keyn-001', padKey:null, title:'Keynapse', subtitle:'Vos idées en bulles vivantes — une constellation de notes qui respire', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'keynapse', ai_optimized:'Whisper', isNew:true, published:false, timeSaved:30, tags:['artefact','notes','idées','constellation','mindmap','bulles','vocal','rappels','carte mentale','keynapse'],
