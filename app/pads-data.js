...
export const CATALOG_DATA = {
    ...
    tools: [
        ...
        { id:'A-COM-003', padKey:null, title:'Brainstorming', subtitle:'La planche d\'ambiance pour votre studio 3D · 1 prompt → 1 moodboard complet', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'muse', ai_optimized:'Claude', isNew:true, published:true, timeSaved:25, tags:['artefact','moodboard','planche-ambiance','studio-3d','illustration-immobiliere','midjourney','flux','muse'],
          longDesc:"Brainstorming prépare la planche d'ambiance à transmettre à votre studio 3D spécialisé en illustration immobilière. Configurez cadrage (drone, piéton, intérieur, terrasse), atmosphère (lumière, saison, palette végétale, figuration, matériaux) et moteur d'image cible (Midjourney v8.1, Flux, DALL-E, Gemini Imagen). Brainstorming assemble un Prompt Maître structuré à coller dans votre IA ; en retour, un fichier HTML avec un bouton \"Copier\" unique qui produit, en une seule génération, une planche moodboard professionnelle de 6 vignettes cohérentes (architecture · lumière · palette végétale · matériaux · lifestyle · détail signature). Pratique standard des studios 3D : une planche cohérente vaut mieux que quatre images éparses." },
