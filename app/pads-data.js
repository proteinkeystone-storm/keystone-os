...
export const CATALOG_DATA = {
    ...
    tools: [
        ...
        { id:'O-IMM-002', padKey:'A2', title:'Annonces Immo', subtitle:'SeLoger · LeBonCoin · Bien\'ici · Logic-Immo · Figaro Immo', category:'IMM', plan:'STARTER', price:29, lifetimePrice:149, icon:'multiportails', ai_optimized:'ChatGPT', isNew:true, published:false, timeSaved:30, tags:['immobilier','annonce','seloger','leboncoin','bienici','diffusion','portails','copywriting'],
        ...
        { id:'O-IMM-010', padKey:null, title:'VEFA Studio', subtitle:'Notice + Contrat — un seul lot, deux livrables', category:'IMM', plan:'STARTER', price:49, lifetimePrice:199, icon:'vefa', ai_optimized:'Claude', isNew:true, published:false, timeSaved:55, tags:['artefact','immobilier','vefa','notice','contrat','réservation','juridique','notaire','re2020'],
        ...
        { id:'A-COM-001', padKey:null, title:'Smart Dynamic QR', subtitle:'QR codes dynamiques · stats souveraines · RGPD', category:'COM', plan:'PRO', price:49, lifetimePrice:199, icon:'sdqr', ai_optimized:'Claude', isNew:true, published:true, timeSaved:10, tags:['artefact','qr','marketing','tracking','vcard','wifi','sovereign','rgpd'],
          longDesc:"Des QR codes à votre marque, qui restent sous votre contrôle même une fois imprimés.\n\n- **Tous les types utiles** : lien, carte de visite, Wi-Fi, événement, texte libre.\n- **Dynamique** : la destination se change à tout moment — le QR déjà imprimé reste valable, zéro réimpression.\n- **Studio de design** : formes, couleurs et logo pour un QR à votre charte, avec contrôle de lisibilité.\n- **Statistiques souveraines** : scans, tendances, heatmap jour par heure — aucune donnée confiée à un tiers, RGPD natif.\n\nVos QR vous appartiennent, hébergés en Europe." },
        ...
        { id:'A-COM-002', padKey:null, title:'Brief Prod', subtitle:'Le brief print/digital infaillible · calculateur d\'échelle', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'kodex', ai_optimized:'Claude', isNew:true, published:true, timeSaved:30, tags:['artefact','print','digital','brief','communication','production'],
          longDesc:"Brief Prod transforme votre intention créative en cahier des charges technique infaillible — fini l'erreur d'impression qui coûte cher.\n\n- **Un entonnoir guidé** par destination : imprimeur, réseaux sociaux, presse.\n- **Une saisie qui parle votre langue** : formats, plis, papiers — chaque choix technique est expliqué simplement.\n- **Le calculateur d'échelle** pour les grands formats : bâche, 4x3, roll-up.\n- **Un coffre-fort d'assets** : logos et visuels à joindre, réunis au même endroit.\n\nÀ la sortie : un brief PDF net, prêt à envoyer à votre graphiste ou votre imprimeur." },
        // ── Sprint Brainstorming V2 — Atelier multi-personnalités IA ──
        { id:'A-COM-003', padKey:null, title:'Brainstorming', subtitle:'9 personnalités IA dialoguent pour enrichir votre réflexion', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'muse', ai_optimized:'Claude + Gemma 4', isNew:true, published:true, timeSaved:30, tags:['artefact','brainstorming','ideation','creatif','multi-agent','synthese','reflexion','strategie'],
          longDesc:"Brainstorming est une table ronde où 9 personnalités IA spécialisées débattent de votre sujet en direct, pour enrichir votre réflexion stratégique.\n\n- **Vous posez le sujet**, choisissez un mode (Exploration, Lancement, Branding…) — et le comité s'allume.\n- **Chaque voix a son rôle** : Strategic Lead coordonne, Creative Director ose, Growth Hacker traduit en leviers, Data Analyst confronte aux ordres de grandeur, Devil's Advocate remet en question…\n- **Vous orientez la conversation** à la volée, comme autour d'une vraie table.\n- **Le Synthesizer tranche** : synthèse structurée + plan d'actions, exportables en PDF.\n\nUn comité de réflexion disponible à toute heure, sans réserver une salle." },
        ...
        { id:'A-COM-004', padKey:null, title:'Key Form', subtitle:'Le formulaire intelligent · URL partageable · notif direction', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'pulsa', ai_optimized:'Claude', isNew:true, published:true, timeSaved:20, tags:['artefact','formulaire','questionnaire','diagnostic','onboarding','collecte','communication','pulsa'],
          longDesc:"Key Form transforme un besoin de collecte en formulaire intelligent, partageable par une simple adresse — sans une ligne de code.\n\n- **Un builder en 4 étapes** : structure, apparence, destinataires, publication.\n- **16 types de champs** : texte avec compteur, choix, upload, classement, signature, date, montant, téléphone…\n- **À vos couleurs** : le formulaire porte votre marque, pas la nôtre.\n- **Publié à une adresse partageable**, pensé mobile d'abord — les réponses arrivent aux destinataires que vous avez choisis, la signature anonyme est garantie.\n\nDiagnostic, audit interne, onboarding fournisseur, candidature, qualification de prospect : un formulaire pour chaque besoin." },
        ...
        { id:'A-COM-005', padKey:null, title:'Ghost Writer', subtitle:'Réécrire vos emails et textes · 3 variantes calibrées · Gemma 4', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'ghostwriter', ai_optimized:'Gemma 4', isNew:true, published:true, timeSaved:15, tags:['artefact','reecriture','copywriting','email','communication','ghostwriter','gemma'],
          longDesc:"Ghost Writer réécrit vos e-mails, messages et textes en trois variantes calibrées, prêtes à copier.\n\n- **Choisissez le contexte** : e-mail professionnel, communication interne, copy marketing, texte long.\n- **Affinez cinq critères** : action, ton, public, intention, longueur.\n- **Comparez d'un coup d'œil** : trois versions distinctes, à coller en un clic.\n- **Disponible partout** : raccourci global dans tout l'OS, intégré nativement dans les ateliers compatibles, avec la bibliothèque de vos 50 dernières réécritures.\n\nMoteur serveur inclus, rien à configurer — ou branchez votre propre clé pour les textes les plus exigeants." },
        // ── Sprint Social-2 — Social Manager (workspace fullscreen) ──
        { id:'O-SOC-001', padKey:null, title:'Social Manager', subtitle:'Composez et publiez sur vos réseaux — Facebook, Instagram, LinkedIn', category:'COM', plan:'PRO', price:49, lifetimePrice:199, icon:'user', ai_optimized:'Claude', isNew:true, published:true, timeSaved:20, tags:['artefact','social','reseaux','facebook','instagram','linkedin','diffusion','publication','community'],
          longDesc:"Social Manager publie vos contenus sur tous vos réseaux depuis un seul endroit — écrit une fois, diffusé partout.\n\n- **Composez une fois** : texte + visuel, avec aperçu en direct avant envoi.\n- **Cochez vos réseaux** : Facebook, Instagram, Threads, Telegram, LinkedIn.\n- **Tout de suite ou à l'heure dite** : publication immédiate ou programmée, réessais automatiques, suivi des envois.\n- **Comptes reliés en sécurité** côté serveur : jetons chiffrés, images hébergées automatiquement.\n\nUn socle extensible : chaque nouveau réseau s'ajoute sans refonte." },
        // ── Sprint SA-0 — Smart Agent (jumeau numérique de savoir-faire) ──
        { id:'O-AGT-001', padKey:null, title:'Smart Agent', subtitle:'Jumeau numérique de votre savoir-faire — répond par chat, voix ou QR, sans rien inventer', category:'COM', plan:'MAX', price:49, lifetimePrice:199, icon:'smart-agent', ai_optimized:'Mistral', isNew:true, published:true, timeSaved:60, tags:['artefact','agent','savoir','kortex','expertise','jumeau','assistant','connaissance','vendeur','voix','qr'],
          longDesc:"Smart Agent transforme votre savoir-faire en un assistant que vos clients interrogent par chat, à la voix ou via un simple QR — sans compte à créer.\n\n- **Nourrissez son coffre en quelques minutes** : pack métier prêt à l'emploi (vendeur, concierge, guide, SAV…), texte collé, page de votre site, PDF — ou l'interview guidée, à l'oral. L'IA structure tout en fiches que vous validez.\n- **Donnez-lui sa personnalité** : rôle, ton, style et objectif — informer, conseiller ou vendre.\n- **Jamais d'invention** : il répond UNIQUEMENT depuis votre savoir validé. S'il ne sait pas, il le dit — et la question remonte dans sa liste de travail pour que vous la combliez.\n- **Il parle** : voix neuronale française incluse, réponse dans la langue du visiteur.\n\nUn vendeur, un concierge, un formateur : même moteur, votre savoir." },
        // ── Sprint Keynapse-0 — espace de connaissances en bulles (constellation perso) ──
        { id:'O-Keyn-001', padKey:null, title:'Keynapse', subtitle:'Vos idées en bulles vivantes — une constellation de notes qui respire', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'keynapse', ai_optimized:'Whisper', isNew:true, published:true, timeSaved:30, tags:['artefact','notes','idées','constellation','mindmap','bulles','vocal','rappels','carte mentale','keynapse'],
          longDesc:"Keynapse transforme vos idées en une constellation vivante, posée sur un canevas infini.\n\n- **Chaque note est une bulle** — projet, idée, personne, lieu, tâche — que vous reliez aux autres pour tisser votre carte mentale.\n- **Zéro dossier, zéro arborescence** : votre pensée s'organise par la couleur, la proximité et les liens, en zones qui respirent.\n- **Des fiches toujours nettes** : description, tâches, rappels, photos, croquis, notes vocales — chaque section vide disparaît.\n- **Dictez un mémo** : il est transcrit, et Keynapse vous propose tâches et rappels à valider d'un geste.\n\nVos idées restent vivantes — et elles restent à vous." },
        // ── Sprint Sentinel-0 — audit web avec suivi (centre de contrôle, Pad O-GEO-001) ──
        { id:'O-GEO-001', padKey:null, title:'Sentinel', subtitle:'Auditez et surveillez vos sites web — disponibilité, SEO, visibilité IA', category:'WEB', plan:'STARTER', price:49, lifetimePrice:199, icon:'sentinel', ai_optimized:'Mistral', isNew:true, published:true, timeSaved:40, tags:['artefact','web','audit','seo','geo','monitoring','surveillance','performance','wix','wordpress'],
          longDesc:"Sentinel surveille vos sites web en continu et vous alerte au moindre incident — votre centre de contrôle, sans dépendance à des outils tiers.\n\n- **Une veille permanente** : disponibilité, temps de réponse, performance, SEO technique, sécurité.\n- **Une note par site**, suivie dans le temps — vous voyez si ça progresse.\n- **Des correctifs clé en main** : le code prêt à coller ou le pas-à-pas selon votre plateforme (Wix, WordPress, sur-mesure), délégables à votre webmaster en un clic.\n- **La fonction phare, la visibilité dans les IA (GEO)** : savez-vous si ChatGPT, Perplexity ou Gemini parlent de vous ?\n\nSouverain, hébergé en Europe." },

        // ── Sprint Sceau-S3 — secret usage-unique scellé E2E + OPRF (Pad O-SEC-001) ──
        { id:'O-SEC-001', padKey:null, title:'Missive', subtitle:'Transmettez un secret qui se lit une fois, puis s’autodétruit', category:'SECURITE', plan:'STARTER', price:49, lifetimePrice:199, icon:'sceau', ai_optimized:null, isNew:true, published:true, timeSaved:10, tags:['artefact','securite','secret','mot de passe','chiffrement','e2e','nfc','qr','ephemere','confidentiel'],
          longDesc:"Missive transmet un secret — mot de passe, code, information sensible — qui se lit une seule fois, puis s'autodétruit.\n\n- **Chiffré sur votre appareil** avant même de partir : même nous ne pouvons pas le lire.\n- **Transmis comme vous voulez** : lien, QR ou puce NFC.\n- **Déverrouillé par un code** que vous donnez par un autre canal — et détruit définitivement après quelques essais ratés.\n- **Zéro trace** : aucun stockage en clair, aucune dépendance tierce au moment de lire.\n\nIdéal pour partager un secret sans le laisser traîner dans une messagerie. Sans IA, souverain." },
        ...
        { id:'O-BRD-001', padKey:null, title:'Key Brand', subtitle:'Votre charte graphique vivante — interactive, à jour, partageable d’un lien', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'keybrand', ai_optimized:null, isNew:true, published:true, timeSaved:12, tags:['artefact','communication','charte','marque','logo','couleurs','typographie','branding','graphiste','identite'],
          longDesc:"Key Brand remplace le PDF de charte graphique par un mini-site interactif, toujours à jour, partageable d'un lien ou d'un QR.\n\n- **Le logo au bon format** : téléchargeable à la taille et au format qu'on vous demande.\n- **Les couleurs copiables en un clic**, avec leurs tests de contraste déjà faits.\n- **Les typographies à l'essai** avec votre propre texte.\n- **Les règles d'usage générées avec VOTRE logo** : les interdits parlent d'eux-mêmes.\n- **Une charte par marque** : la vôtre, ou celles de vos clients.\n\nZéro IA, zéro crédit : tout est inclus." },
        // ── Sprint NK-0 — networK : réseau relationnel vivant (Pad O-NET-001) ──
        { id:'O-NET-001', padKey:null, title:'networK', subtitle:'Votre réseau relationnel vivant — vos contacts en carte mentale, pas en base de données', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'network', ai_optimized:null, isNew:true, published:true, timeSaved:20, tags:['artefact','contacts','reseau','relations','crm','carte mentale','clients','fournisseurs','partenaires','network'],
          longDesc:"networK n'est pas un carnet d'adresses de plus : c'est votre réseau relationnel vivant, déployé en carte mentale autour de vous.\n\n- **Vos relations en constellation** : clients, fournisseurs, partenaires, équipe, presse — dans des catégories que vous créez librement.\n- **Une fiche claire par contact** : coordonnées, rôles, tags, notes.\n- **Un journal d'activité** qui raconte votre relation comme une histoire.\n- **Continuez sans ressaisir** : depuis une fiche, envoyez une Missive, générez un Brief, ouvrez votre Smart Agent — tout part déjà pré-rempli.\n\nZéro IA, zéro crédit : votre réseau vous appartient." },
        // ── Sprint BK-0 — booK : flipbooks souverains, export autoporté (Pad O-BOK-001) ──
        { id:'O-BOK-001', padKey:null, title:'booK', subtitle:'Vos flipbooks en un fichier qui s\'ouvre partout, pour toujours — sans abonnement, sans serveur', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'book', ai_optimized:null, isNew:true, published:true, timeSaved:15, tags:['artefact','communication','flipbook','catalogue','magazine','brochure','plaquette','menu','pdf','book','publication','editorial'],
          longDesc:"booK transforme votre PDF ou vos images en flipbook élégant — catalogue, magazine, plaquette, menu — que l'on feuillette comme un vrai livre.\n\n- **UN seul fichier autonome** : il s'ouvre d'un double-clic, partout, pour toujours — sans serveur, sans abonnement, sans watermark.\n- **Il ne dépend même pas de Keystone** : envoyez-le par e-mail, posez-le sur une clé USB, archivez-le.\n- **Il reste rééditable** : ré-importez-le dans booK, même des années plus tard, il redevient modifiable.\n- **Votre bibliothèque** garde tous vos flipbooks sous la main.\n\nZéro IA, zéro crédit : il vous appartient." },
        // ── Sprint DK-1 — desK : chemin de fer vivant d'une revue (Pad O-DSK-001) ──
        { id:'O-DSK-001', padKey:null, title:'desK', subtitle:'Le chemin de fer vivant de votre revue — qui doit livrer quoi, quand, et quoi faire quand ça dérape', category:'COM', plan:'STARTER', price:49, lifetimePrice:199, icon:'desk', ai_optimized:null, isNew:true, published:true, timeSaved:25, tags:['artefact','communication','revue','magazine','journal','redaction','chemin de fer','bouclage','editorial','presse','flatplan'],
          longDesc:"desK pilote la production de votre revue : le chemin de fer papier devient une frise vivante de cartes-pages, partagée par toute l'équipe.\n\n- **Une carte par page** — couverture, édito, grand dossier : chacun voit qui doit livrer quoi, et pour quand.\n- **La marge avant bouclage** : tant qu'elle tient, rien ne s'allume. Quand un retard la consomme, la carte passe à l'ambre, puis au rouge.\n- **L'inspecteur vous tend la décision** : relancer le contributeur, ou basculer sur un remplaçant préparé au banc.\n- **Simulez un report de remise** : la date d'impression réagit en direct.\n- **La maquette reste dans InDesign** : desK est le cockpit autour, pas un logiciel de mise en page de plus.\n\nMulti-revues, équipe invitée par e-mail, zéro IA au cœur." },
    ],
};
