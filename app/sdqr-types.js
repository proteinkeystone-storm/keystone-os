...
export const QR_TYPES = {
  ...
  sms: {
    ...
    supports : { static: true, dynamic: false },
    fields : [
      { id: 'phone',   type: 'tel',      label: 'Numéro',             required: true, placeholder: '+33 6 12 34 56 78' },
  ...
  whatsapp: {
    ...
    supports : { static: true, dynamic: false },
    fields : [
      { id: 'phone',   type: 'tel',      label: 'Numéro (format international)', required: true, placeholder: '33612345678' },
      { id: 'message', type: 'textarea', label: 'Message pré-rempli',           placeholder: 'Bonjour…', span: 'full' },
    ],
