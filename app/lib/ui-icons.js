...
export const ICONS = {
  ...
  // Réindexation / rafraîchir (Lucide refresh-cw) — absent jusqu'ici : les
  // boutons qui l'appelaient (mode Repositionnement, « Défaut » Key Brand)
  // rendaient un picto vide.
  ...
  // Actions rapides fiche contact networK (téléphone, message) — outline Lucide.
  ...
  // Bouclier nu — niveau intermédiaire de la jauge Missive (le bouclier
  // coché marque le niveau maximal). Même tracé, sans la coche.
