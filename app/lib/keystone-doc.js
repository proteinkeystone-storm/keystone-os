...
export const DOC_CHANGELOG = [
  { date: 'Août 2026', items: [
    'desK — une page figée porte sa couleur en bloc plein. Une page figée (pub vendue, couverture) restait grise même quand elle appartenait à une rubrique — sa fiche ne permettait d\'ailleurs pas d\'en choisir une. Désormais la fiche d\'une page figée propose la rubrique, et dès qu\'elle en a une, sa carte se remplit entièrement de sa couleur : le même signal qu\'une page finie, car une page figée est réglée par nature. L\'étiquette et le point de statut passent à une encre lisible quelle que soit la teinte, dans les deux thèmes.',
    'desK — les numéros de pages se règlent enfin comme dans votre maquette. Une revue est souvent faite de deux documents : le cahier de couverture (couverture, 2ᵉ, 3ᵉ et 4ᵉ de couv) qui entoure les pages intérieures — desK numérotait tout d\'un seul tenant, les dernières pages héritaient d\'un numéro d\'intérieur et rien ne tombait juste. Désormais, ouvrez la fiche d\'une page → « Numérotation » : sortez-la de la numérotation (elle s\'affiche « 3ᵉ de couv », « 4ᵉ de couv »… selon sa place) ou imposez-lui le numéro de votre choix — toute la suite se recale d\'elle-même, même chemin de fer déjà construit, avec un aperçu avant d\'appliquer. L\'ordre réel des pages ne bouge pas, et ce réglage reste entre les mains du responsable de la publication.',
    'desK — la frise des échéances tient enfin sur un téléphone. En haut du chemin de fer, la ligne du temps (bouclage, maquette, imprimeur, parution) était plus large que l\'écran d\'un iPhone : elle se coupait au milieu d\'un mot et il fallait la faire glisser du doigt pour lire la suite. Elle s\'ajuste désormais à la largeur disponible, et deux échéances trop rapprochées se regroupent en un seul repère qui porte les deux dates — vous voyez toute la ligne de vie du numéro d\'un seul coup d\'œil, sans rien faire glisser.',
    'desK — la fiche d\'une page ne recouvre plus le chemin de fer : elle lui prend sa place. Sur ordinateur et tablette en paysage, ouvrir une carte rétrécit le chemin de fer d\'autant, et les planches se réarrangent toutes seules pour tenir dans ce qui reste — vous gardez la vue d\'ensemble du numéro pendant que vous travaillez sur une page, au lieu d\'avoir un tiers de la grille masqué. La carte que vous venez d\'ouvrir reste dans le champ de vision même si le réarrangement la fait descendre. Sur téléphone, rien ne change : la fiche reste une feuille qui remonte du bas.',
    'Correction — le correcteur se trompe beaucoup moins, et il apprend vos noms. Il ne signale plus les noms propres qu\'il ne connaît pas quand ils sont au milieu d\'une phrase : sur de vrais articles, cinq alertes sur six étaient injustifiées, il n\'en reste qu\'une sur deux — sans en rater davantage, au contraire (une faute de plus retrouvée). Les noms que vous lui apprenez avec « toujours ignorer » ne restent plus dans votre navigateur : ils valent pour toutes les personnes de votre abonnement, une fois pour toutes. Et une liste de vocabulaire courant (grades abrégés, civilités, renvois) est livrée avec l\'outil.',
    'Correction — un tri assisté des alertes, et comment le couper. La détection reste entièrement sur votre appareil, comme avant : c\'est un correcteur qui tourne dans votre navigateur, hors ligne, et votre document ne part jamais. En complément, un assistant peut écarter en silence les alertes manifestement injustifiées ; pour cela, seuls les mots déjà signalés et la phrase qui les porte sont vérifiés en ligne — jamais votre texte entier. Il ne peut qu\'enlever du bruit : il n\'ajoute jamais d\'alerte et ne réécrit rien. Pour rester à 100 % sur votre appareil, cliquez « Tri des alertes » au-dessus de votre texte : il passe sur « sur l\'appareil » et plus rien ne sort. Chaque nom reconnu comme légitime rejoint votre vocabulaire et n\'est plus jamais envoyé.',
    'desK — faire entrer un article à la main, avec son document. Jusqu\'ici, une copie accompagnée de son fichier n\'entrait que par l\'adresse e-mail de dépôt ; quand un contributeur vous remet son texte autrement (clé USB, WeTransfer, en main propre), il fallait créer la fiche puis rouvrir le casier pour y joindre le fichier. Désormais l\'onglet « Marbre » porte une bande « Importer un article » : glissez-y le document reçu (Word, PDF, photo) — n\'importe où sur l\'onglet — et la fiche s\'ouvre avec la pièce déjà jointe et un titre proposé d\'après le nom du fichier, que vous corrigez si besoin. « Fiche vide » reste là pour un article sans document.',
    'desK — la fiche ne se réinitialise plus pendant que vous la remplissez. desK se met à jour tout seul toutes les 45 secondes et à chaque retour dans l\'onglet, pour voir ce que fait le reste de l\'équipe ; cette mise à jour reconstruisait l\'écran et pouvait effacer un formulaire en cours (nouvel article, modification, relance, tri du courrier, nouveau numéro), un choix ou une confirmation ouverts dans la fiche. Désormais elle attend que vous ayez fini — et se rattrape dès que le panneau se ferme. Un aller-retour dans Mail pour copier une adresse ne vous fait plus rien perdre.',
    'desK — la fiche d\'une page, retouchée : les étapes (proposé, attendu, remis, relu, maquetté) se DÉCOCHENT — touchez l\'étape en cours pour reculer d\'un cran si vous vous êtes trompé, ou une étape passée pour y revenir ; avancer se fait toujours d\'un cran à la fois. Le casier — là où vivent les pièces de la page : texte, photos, PDF — est encadré d\'or et remonte juste sous l\'état de l\'article, avec un bouton « télécharger » en or sur chaque pièce. Et « Étaler sur les pages suivantes » comme « Ajouter un article ici » sont de vrais boutons.',
    'desK — une page finie se voit de loin : dès que tous les articles d\'une page sont maquettés (ou publiés), sa carte se remplit entièrement de la couleur de sa rubrique — plus seulement le liseré du haut. Au plus petit cran du curseur, là où les libellés disparaissent, le chemin de fer montre ainsi d\'un seul regard ce qui est bouclé et ce qui reste à faire. Le texte reste lisible quelle que soit la couleur de la rubrique : encre sombre sur une teinte claire, blanche sur une teinte profonde.',
    'Période d\'essai — quand votre accès est une invitation à essayer une application pour quelques jours, un petit chronomètre « Essai · 7 j » s\'affiche en haut du tableau de bord, au-dessus de l\'heure : il s\'éteint jour après jour, passe à l\'ambre quand il reste deux jours, et vous dit au survol jusqu\'à quelle date vous êtes couvert. Cliquez dessus (ou ouvrez Réglages → Ma Licence) : vous y trouvez « S\'abonner à … » avec le prix mensuel. Si vous vous abonnez, rien ne change pour vous — même clé, mêmes données, l\'abonnement prend simplement le relais et le chronomètre disparaît.',
    'Ghost Writer — un réglage « Écriture » : Standard ou Naturelle. En écriture naturelle, l\'IA écrit comme une personne qui connaît son sujet — des phrases de longueurs variées, du concret, sans les tournures toutes faites qu\'on reconnaît d\'un assistant (« n\'hésitez pas à », « il est important de », les listes à puces partout, les tirets à répétition, la petite conclusion qui répète tout). Le choix se fait dans la fenêtre Ghost Writer ou dans le Studio, il est mémorisé pour votre compte et vaut aussi pour les boutons ✦ des autres outils. Les posts composés depuis la chaîne de contenu l\'appliquaient déjà.',
    'Ghost Writer — le texte qui sort est propre : tout ce que Ghost Writer rend (et tout ce que vous lui collez) est débarrassé des caractères invisibles qui traînent dans un texte copié depuis Word, un site ou un autre assistant — espaces de largeur nulle, traits d\'union cachés, marques de fichier. Ils ne se voient pas mais ils cassent une recherche, un compte de caractères ou une mise en page. La typographie française (espaces insécables devant : ; ! ? et dans les « guillemets ») est, elle, scrupuleusement conservée.',
  ]},
  { date: 'Juillet 2026', items: [
    'Missive — un engagement à cocher avant votre première missive. Parce que nous ne pouvons pas lire ce que vous envoyez (c\'est tout l\'intérêt), nous vous demandons une fois, en toutes lettres, de ne pas vous servir de cette confidentialité pour menacer, faire chanter ou transmettre quelque chose d\'interdit. Pour la même raison, nous conservons de notre côté le nombre de missives envoyées et leurs horaires pendant 90 jours — jamais leur contenu, jamais leurs destinataires — afin de pouvoir repérer un usage manifestement abusif. Rien d\'autre ne change : la personne qui reçoit votre missive ne voit aucune différence.',
    'Smart Agent — vos PDF illustrés entrent enfin en entier, et ils ne quittent plus votre poste : déposez un manuel, Keystone le lit SUR VOTRE APPAREIL. Le fichier lui-même n\'est jamais envoyé — seuls le texte et les images de pages que vous retenez partent. Conséquence directe : la limite de taille disparaît, un manuel de plusieurs centaines de mégaoctets passe désormais alors qu\'il était tout simplement refusé. Et chaque page vous propose sa « planche » (l\'image de la page) à rattacher aux fiches de votre choix : sur un manuel technique, la photo montre souvent ce que le texte ne dit pas. Vous décochez ce que vous ne voulez pas, et le poids exact de ce qui va être envoyé s\'affiche avant que vous validiez.',
    'Smart Agent — les renvois aux photos sont conservés : quand une procédure dit « pivotez le pied d\'appui - Photo 2 », la mention reste à sa place dans l\'étape, et l\'agent affiche la planche correspondante sous sa réponse. Le geste décrit et l\'image qui le montre ne sont plus séparés.',
    'Smart Agent — le champ « avertissement » d\'une procédure ne sert plus qu\'au danger : ce qui blesse, ce qui est irréversible, ce qui est formellement interdit. Les avantages et les justifications, qui s\'y glissaient parfois, partent désormais là où ils doivent aller. Et un avertissement s\'affiche à son propre niveau, en rouge — dans la fiche, dans la liste du coffre et sous les réponses de l\'agent, repris mot pour mot depuis votre fiche. Un champ de danger dilué finit par ne plus être lu : celui-ci ne peut plus l\'être.',
    'Smart Agent — le nombre de fiches proposées suit désormais la matière réellement disponible : sur un passage court, l\'IA ne rend plus la même idée trois fois sous des formes différentes pour faire du nombre. Et l\'alerte « ce lot est très dense, du contenu peut manquer » ne se déclenche plus à tort — quand elle apparaît, elle veut vraiment dire quelque chose.',
